...
/*document.addEventListener("keydown", function (event) { alert("Tecla pressionada é" + " " + event.key);

});*/

/*essse é um jeito de fazer o mario ==>>
...
/*const audio = new Audio("/audios/audioEsperandoIniciarJogo.mp3")*/
...
/*console.log("largura do cenaraio:" + larguraCenario);
console.log("largura do personagem:" + larguraPersonagem);*/
...
pontos.textContent = moedasAtual;
...
function colisaoComBloco() {
    ...
    if (
        ...
        audioMoeda.play();
        checarMoedas();
        bloco.style.top = "370px";
        setTimeout(() => {
            bloco.style.top = "380px";
        }, 90);
        checarMoedas();
        setTimeout(() => {
